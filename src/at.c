...
static int speed_name(const char*s){if(!strncasecmp(s,"V21",3))return 300;if(!strncasecmp(s,"V22B",4))return 2400;if(!strncasecmp(s,"V22",3))return 1200;if(!strncasecmp(s,"V32",3))return 9600;if(!strncasecmp(s,"V34",3))return 33600;return atoi(s);}
