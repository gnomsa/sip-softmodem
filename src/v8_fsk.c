...
size_t v8_fsk_set_sequence(struct v8_fsk*f,const uint8_t*b,size_t n){if(n>sizeof f->tx)n=sizeof f->tx;memcpy(f->tx,b,n);f->tx_count=n;f->tx_at=0;f->tx_clock=0;return n;}
