...
#include <stddef.h>
#include <stdint.h>
struct v32 { uint8_t tq[4096],rq[4096];size_t th,tt,rh,rt;int rate,bits;unsigned tf;int tb,rx_bits,rx_receiving;unsigned rframe;double tx_clock,rx_clock,tx_i,tx_q,rx_i,rx_q,rx_cc,rx_ss,rx_cs;uint64_t tx_samples,rx_samples; };
