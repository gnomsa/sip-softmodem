...
SRC := src/main.c src/at.c src/pcma.c src/rtp.c src/jitter.c src/sip.c src/v21.c src/v22.c src/v22bis.c src/v22_handshake.c src/v32.c src/v8.c src/v8_fsk.c src/v8_session.c src/ansam.c src/tone_detector.c src/pty.c
OBJ := $(SRC:.c=.o)
...
test: tests/test_core tests/test_tones tests/test_v22_handshake tests/test_v8 tests/test_v8_fsk tests/test_v8_session tests/test_ansam
	./tests/test_core
	./tests/test_tones
...
clean:
	rm -f $(OBJ) sip-softmodem tests/test_core tests/test_tones tests/test_v22_handshake tests/test_v8 tests/test_v8_fsk tests/test_v8_session tests/test_ansam tests/dsp_link
