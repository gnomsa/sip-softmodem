...
SRC += src/v34_phase2_tone.c
SRC += src/v34_phase2_ranging.c
SRC += src/v34_probe.c
SRC += src/v34_phase2_probe_exchange.c
SRC += src/v34_phase2_session.c
SRC += src/v34_modem_session.c
...
SRC += src/v34_uart.c
SRC += src/v34_data_channel.c
SRC += src/v34_b1_data_link.c
SRC += src/v34_phase4_stream.c
...
test: sip-softmodem tests/test_core tests/test_tones tests/test_v22_handshake tests/test_v8 tests/test_v8_fsk tests/test_v8_session tests/test_ansam tests/test_v32_std tests/test_v32bis_trellis tests/test_v32bis_map tests/test_v32bis_viterbi tests/test_v32bis_data tests/test_v32bis_qam tests/test_v32bis_link tests/test_v32_training tests/test_v32_line tests/test_v32_rate tests/test_v32_e tests/test_v32_data tests/test_v32_qam tests/test_v32_startup tests/test_v32_startup_link tests/test_v32_retrain tests/test_v32_session tests/test_v42_hdlc tests/test_v42_lapm tests/test_v42_arq tests/test_v42_link tests/test_v42_xid tests/test_v42_session tests/test_v42_stream tests/test_v42_v32 tests/test_v34_caps tests/test_v34_info tests/test_v34_info1 tests/test_v34_info_modem tests/test_v34_phase2 tests/test_v34_phase2_tone tests/test_v34_phase2_ranging tests/test_v34_probe tests/test_v34_probe_detector tests/test_v34_phase2_probe_exchange tests/test_v34_phase2_session tests/test_v34_timing tests/test_v34_phase3 tests/test_v34_training_symbols tests/test_v34_training_tx tests/test_v34_phase3_stream tests/test_v34_j_detector tests/test_v34_training_rx tests/test_v34_phase3_link tests/test_v34_phase3_receiver tests/test_v34_mp tests/test_v34_phase4 tests/test_v34_phase4_link tests/test_v34_mp_receiver tests/test_v34_framing tests/test_v34_b1 tests/test_v34_mapper tests/test_v34_data_mapper tests/test_v34_trellis tests/test_v34_b1_stream tests/test_v34_data_stream tests/test_v34_data_decoder tests/test_v34_b1_receiver tests/test_v34_uart tests/test_v34_data_channel tests/test_v34_b1_data_link tests/test_v34_phase4_stream tests/test_v34_phase4_b1_data tests/test_v34_session tests/test_v34_modem_session
	...
	./tests/test_v34_phase2_tone
	./tests/test_v34_phase2_ranging
	./tests/test_v34_probe
	./tests/test_v34_probe_detector
	./tests/test_v34_phase2_probe_exchange
	./tests/test_v34_phase2_session
	...
	./tests/test_v34_phase3_receiver
	./tests/test_v34_mp
	...
	./tests/test_v34_uart
	./tests/test_v34_data_channel
	./tests/test_v34_b1_data_link
	./tests/test_v34_phase4_stream
	./tests/test_v34_phase4_b1_data
	./tests/test_v34_session
	./tests/test_v34_modem_session
...
integration-v34-all-test: sip-softmodem
	@for rate in $$(seq 2400 2400 33600); do \
...
tests/test_pty: tests/test_pty.c src/pty.c
	$(CC) $(CFLAGS) -iquote src -o $@ $^ $(LDLIBS)
...
tests/test_v34_phase2_ranging: tests/test_v34_phase2_ranging.c src/v34_phase2_ranging.c src/v34_phase2_tone.c src/v34_info_modem.c src/v34_info.c src/pcma.c
	$(CC) $(CFLAGS) -Isrc -o $@ $^ $(LDLIBS)

tests/test_v34_probe: tests/test_v34_probe.c src/v34_probe.c src/pcma.c
	$(CC) $(CFLAGS) -Isrc -o $@ $^ $(LDLIBS)

tests/test_v34_probe_detector: tests/test_v34_probe_detector.c src/v34_probe.c src/v34_phase2_tone.c src/v34_info_modem.c src/pcma.c
	$(CC) $(CFLAGS) -Isrc -o $@ $^ $(LDLIBS)

tests/test_v34_phase2_probe_exchange: tests/test_v34_phase2_probe_exchange.c src/v34_phase2_probe_exchange.c src/v34_phase2.c src/v34_probe.c src/v34_info_modem.c src/v34_info.c src/v34_caps.c src/pcma.c
	$(CC) $(CFLAGS) -Isrc -o $@ $^ $(LDLIBS)

tests/test_v34_phase2_session: tests/test_v34_phase2_session.c src/v34_phase2_session.c src/v34_phase2_probe_exchange.c src/v34_phase2_ranging.c src/v34_phase2_tone.c src/v34_phase2.c src/v34_probe.c src/v34_info_modem.c src/v34_info.c src/v34_caps.c src/pcma.c
	$(CC) $(CFLAGS) -Isrc -o $@ $^ $(LDLIBS)
...
tests/test_v34_phase3_receiver: tests/test_v34_phase3_receiver.c src/v34_phase3_receiver.c src/v34_phase3_stream.c src/v34_phase3.c src/v34_timing.c src/v34_training_symbols.c src/v34_training_tx.c src/v34_training_rx.c src/v34_j_detector.c src/v34_caps.c src/pcma.c
	$(CC) $(CFLAGS) -Isrc -o $@ $^ $(LDLIBS)
...
tests/test_v34_uart: tests/test_v34_uart.c src/v34_uart.c
	$(CC) $(CFLAGS) -Isrc -o $@ $^ $(LDLIBS)

tests/test_v34_data_channel: tests/test_v34_data_channel.c src/v34_data_channel.c src/v34_data_stream.c src/v34_data_receiver.c src/v34_uart.c src/v34_b1_receiver.c src/v34_data_decoder.c src/v34_b1_stream.c src/v34_qam_tx.c src/v34_trellis.c src/v34_data_mapper.c src/v34_mapper.c src/v34_b1.c src/v34_framing.c src/v34_training_symbols.c src/v34_training_rx.c src/v34_timing.c src/v34_caps.c src/pcma.c
	$(CC) $(CFLAGS) -Isrc -o $@ $^ $(LDLIBS)

tests/test_v34_b1_data_link: tests/test_v34_b1_data_link.c src/v34_b1_data_link.c src/v34_data_channel.c src/v34_data_stream.c src/v34_data_receiver.c src/v34_uart.c src/v34_b1_receiver.c src/v34_data_decoder.c src/v34_b1_stream.c src/v34_qam_tx.c src/v34_trellis.c src/v34_data_mapper.c src/v34_mapper.c src/v34_b1.c src/v34_framing.c src/v34_training_symbols.c src/v34_training_rx.c src/v34_timing.c src/v34_caps.c src/pcma.c
	$(CC) $(CFLAGS) -Isrc -o $@ $^ $(LDLIBS)

tests/test_v34_phase4_stream: tests/test_v34_phase4_stream.c src/v34_phase4_stream.c src/v34_phase4_receiver.c src/v34_phase4.c src/v34_mp_receiver.c src/v34_mp.c src/v34_info.c src/v34_training_symbols.c src/v34_training_tx.c src/v34_training_rx.c src/v34_timing.c src/v34_caps.c src/pcma.c
	$(CC) $(CFLAGS) -Isrc -o $@ $^ $(LDLIBS)

tests/test_v34_phase4_b1_data: tests/test_v34_phase4_b1_data.c src/v34_phase4_stream.c src/v34_phase4_receiver.c src/v34_b1_data_link.c src/v34_data_channel.c src/v34_data_stream.c src/v34_data_receiver.c src/v34_uart.c src/v34_b1_receiver.c src/v34_data_decoder.c src/v34_b1_stream.c src/v34_qam_tx.c src/v34_phase4.c src/v34_mp_receiver.c src/v34_mp.c src/v34_info.c src/v34_trellis.c src/v34_data_mapper.c src/v34_mapper.c src/v34_b1.c src/v34_framing.c src/v34_training_symbols.c src/v34_training_tx.c src/v34_training_rx.c src/v34_timing.c src/v34_caps.c src/pcma.c
	$(CC) $(CFLAGS) -Isrc -o $@ $^ $(LDLIBS)

tests/test_v34_session: tests/test_v34_session.c src/v34_session.c src/v34_phase3_receiver.c src/v34_phase3_stream.c src/v34_j_detector.c src/v34_phase3.c src/v34_phase4_stream.c src/v34_phase4_receiver.c src/v34_b1_data_link.c src/v34_data_channel.c src/v34_data_stream.c src/v34_data_receiver.c src/v34_uart.c src/v34_b1_receiver.c src/v34_data_decoder.c src/v34_b1_stream.c src/v34_qam_tx.c src/v34_phase4.c src/v34_mp_receiver.c src/v34_mp.c src/v34_info.c src/v34_trellis.c src/v34_data_mapper.c src/v34_mapper.c src/v34_b1.c src/v34_framing.c src/v34_training_symbols.c src/v34_training_tx.c src/v34_training_rx.c src/v34_timing.c src/v34_caps.c src/pcma.c
	$(CC) $(CFLAGS) -Isrc -o $@ $^ $(LDLIBS)

tests/test_v34_modem_session: tests/test_v34_modem_session.c src/v34_modem_session.c src/v34_phase2_session.c src/v34_phase2_probe_exchange.c src/v34_phase2_ranging.c src/v34_phase2_tone.c src/v34_phase2.c src/v34_probe.c src/v34_info_modem.c src/v34_session.c src/v34_phase3_receiver.c src/v34_phase3_stream.c src/v34_j_detector.c src/v34_phase3.c src/v34_phase4_stream.c src/v34_phase4_receiver.c src/v34_b1_data_link.c src/v34_data_channel.c src/v34_data_stream.c src/v34_data_receiver.c src/v34_uart.c src/v34_b1_receiver.c src/v34_data_decoder.c src/v34_b1_stream.c src/v34_qam_tx.c src/v34_phase4.c src/v34_mp_receiver.c src/v34_mp.c src/v34_info.c src/v34_trellis.c src/v34_data_mapper.c src/v34_mapper.c src/v34_b1.c src/v34_framing.c src/v34_training_symbols.c src/v34_training_tx.c src/v34_training_rx.c src/v34_timing.c src/v34_caps.c src/pcma.c
	$(CC) $(CFLAGS) -Isrc -o $@ $^ $(LDLIBS)

clean:
	rm -f tools/pcap_pcma_extract tools/v32_pcma_replay tools/ppp_fcs_check
	rm -f tests/test_pty
