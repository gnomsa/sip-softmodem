...
SRC := src/main.c src/at.c src/pcma.c src/rtp.c src/jitter.c src/sip.c src/v21.c src/v22.c src/pty.c
OBJ := $(SRC:.c=.o)
...
tests/dsp_link: tests/dsp_link.c src/v21.c src/v22.c src/pcma.c
