...
int main(void)
{
    ...
    for (packet = 0; packet < 200u; ++packet) {
        ...
        assert(v34_session_receive(&caller, answer_pcma));
        assert(v34_session_receive(&answerer, call_pcma));
    ...
    printf("v34 session: Phase 3/4/B1, 33600/28800, %zu + %zu bytes\n",
